...
def compute_and_result():
    ...
    wavelength, m, n, z, wx0, wy0 = get_hermite_gaussian_params_from_session(KEY_PREFIX)
    ...
    if PAGE_KEY in cache:
        ...
        save_result_mat_button(mat_bytes, "hermite_gaussian_result.mat", f"{KEY_PREFIX}_save_mat")
